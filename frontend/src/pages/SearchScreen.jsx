...
const SearchScreen = () => {
    ...
    const [avgFilter, setAvgtFilter] = useState(false)
                ...
                <Col md={3}>
                    <div className="filter-container">
                        <div className="div-container">
                            <h4>Department</h4>
                            <span onClick={() => setDepartmentFilter(!departmentFilter)} className="material-symbols-outlined">
                                expand_more
                            </span>
                        </div>
                        {departmentFilter ? <ul>
                    ...
                    <div className="filter-container">
                        ...
                        <div className="div-container">
                            <h4>Price</h4>
                            <span onClick={() => setPriceFilter(!priceFilter)} className="material-symbols-outlined">
                                expand_more
                            </span>
                        </div>
                        {priceFilter ? <ul>
                    ...
                    <div>
                        ...
                        {/* <button onClick={()=>setAvgtFilter(!avgFilter)}>open</button> */}
                        {/* {avgFilter ?  */}
                        {/* <ul>
                            {ratings.map((r) => (
                                <li key={r.name}>
